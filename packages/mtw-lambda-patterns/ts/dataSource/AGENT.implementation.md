...
**First consumer (ephemera):** membership presentation emission on [`mtw.ephemera.perception`](../../../../lambda/ephemera/dataSource/perception/AGENT.md) --- cluster spec in [`membershipPresentationFanIn.ts`](../../../../lambda/ephemera/dataSource/perception/membershipPresentationFanIn.ts); **`FanInClusterStore`** wiring shipped on [`index.ts`](../../../../lambda/ephemera/dataSource/perception/index.ts) (deferral tag **`fanIn-mtw.ephemera.perception`**, sequential **`receiveEvents`** loop; **`afterSettled`** no-ops when no open partials). Emission **`PublishMessage`** pending. Task plan: [`taskPlanning/.../AGENT.fanInPattern.planning.md`](../../../../taskPlanning/packages/mtw-lambda-patterns/ts/dataSource/AGENT.fanInPattern.planning.md) Phase 1.
