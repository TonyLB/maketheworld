...
import { isSchemaKnowledge, isSchemaRender } from "@tonylb/mtw-base/ts/schema/components"
...
export class StandardKnowledgePayload implements ComponentConstructorMethods<StandardKnowledgeData, StandardKnowledgeData> {
            ...
            consumers.push(
                new StandardizeConsumerSimple(this, {
                    ...
                    update(matched) {
                        ...
                        if (matched.length > 1) {
                            throw new Error('Knowledge must contain at most one Render tag')
                        }
    ...
    assureReferences(children: StandardReference[]): AssureReferencesResult<this> {
        return {
            payload: new StandardKnowledgePayload(this) as this,
