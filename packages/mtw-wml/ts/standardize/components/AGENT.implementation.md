...
- **Runtime projection (shipped):** Ephemera affordance pipeline hydrates **`projectRoomExits`** via gateways **`componentTopology`** and **`affordanceCache`** ([`lambda/ephemera/dataSource/affordanceOrchestration/AGENT.md`](../../../../../lambda/ephemera/dataSource/affordanceOrchestration/AGENT.md), [`affordanceCache/AGENT.md`](../../../../../lambda/ephemera/dataSource/affordanceCache/AGENT.md)). Production topology restore: [`taskPlanning/packages/mtw-wml/ts/AGENT.topologyRelationsRefactor.planning.md`](../../../../taskPlanning/packages/mtw-wml/ts/AGENT.topologyRelationsRefactor.planning.md) Phase 4.
