...
describe('ReferenceCollection', () => {
    describe('constructor', () => {
        ...
        it('should create collection with single reference', () => {
            const ref = new StandardReferenceSimple({ key: 'room1', tag: 'Room' })
        ...
        it('should deduplicate identical references', () => {
            const ref1 = new StandardReferenceSimple({ key: 'room1', tag: 'Room' })
            const ref2 = new StandardReferenceSimple({ key: 'room1', tag: 'Room' })
        ...
        it('should merge references that match by key', () => {
            const ref1 = new StandardReferenceSimple({ key: 'room1', tag: 'Room' })
            const ref2 = new StandardReferenceSimple({ key: 'room1', universalKey: 'ROOM#uuid1', tag: 'Room' })
            const collection = new ReferenceCollection([ref1, ref2])
            expect(collection.references.length).toBe(1)
            expect(collection.references[0].key).toBe('room1')
        ...
        it('should merge references that match by universalKey', () => {
            const ref1 = new StandardReferenceSimple('ROOM#uuid1', 'Room')
            const ref2 = new StandardReferenceSimple({ key: 'room1', universalKey: 'ROOM#uuid1', tag: 'Room' })
            const collection = new ReferenceCollection([ref1, ref2])
            expect(collection.references.length).toBe(1)
            expect(collection.references[0].key).toBe('room1')
        ...
        it('should merge multiple partial references into one complete reference', () => {
            const ref1 = new StandardReferenceSimple({ key: 'room1', tag: 'Room' })
            const ref2 = new StandardReferenceSimple('ROOM#uuid1', 'Room')
            const ref3 = new StandardReferenceSimple({ key: 'room1', universalKey: 'ROOM#uuid1', tag: 'Room' })
        ...
        it('should keep distinct references separate', () => {
            const ref1 = new StandardReferenceSimple({ key: 'room1', tag: 'Room' })
            const ref2 = new StandardReferenceSimple({ key: 'room2', tag: 'Room' })
            const ref3 = new StandardReferenceSimple('FEATURE#uuid1', 'Feature')
            const collection = new ReferenceCollection([ref1, ref2, ref3])
        ...
        it('should throw error when merging references with different tags', () => {
            const ref1 = new StandardReferenceSimple({ key: 'room1', tag: 'Room' })
            const ref2 = new StandardReferenceSimple({ key: 'room1', tag: 'Feature' })
        ...
        it('should handle references with only universalKey', () => {
            const ref1 = new StandardReferenceSimple('ROOM#uuid1', 'Room')
            const ref2 = new StandardReferenceSimple('ROOM#uuid2', 'Room')
            const collection = new ReferenceCollection([ref1, ref2])
    ...
    describe('lookup', () => {
        it('should find matching reference by key', () => {
            const ref1 = new StandardReferenceSimple({ key: 'room1', universalKey: 'ROOM#uuid1', tag: 'Room' })
            const collection = new ReferenceCollection([ref1])
    ...
    describe('integration scenarios', () => {
        it('should handle typical construction and lookup flow', () => {
            const appearances = [
                new StandardReferenceSimple({ key: 'room1', tag: 'Room' }),
                new StandardReferenceSimple('ROOM#uuid1', 'Room'),
                new StandardReferenceSimple({ key: 'room1', universalKey: 'ROOM#uuid1', tag: 'Room' }),
                new StandardReferenceSimple({ key: 'room2', universalKey: 'ROOM#uuid2', tag: 'Room' }),
                new StandardReferenceSimple('FEATURE#uuid1', 'Feature')
            ]
        ...
        it('should handle withReference chain', () => {
            const collection = new ReferenceCollection([])
                .withReference(new StandardReferenceSimple({ key: 'room1', tag: 'Room' }))
                .withReference(new StandardReferenceSimple({ key: 'room1', universalKey: 'ROOM#uuid1', tag: 'Room' }))
                .withReference(new StandardReferenceSimple({ key: 'room2', tag: 'Room' }))
