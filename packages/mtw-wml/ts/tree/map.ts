...
type TreeMapCallback = (incoming: any) => typeof incoming extends { data: any, children: any } ? typeof incoming["children"] : never
...
type TreeMapCallbackAsync = (incoming: any) => typeof incoming extends { data: any, children: any } ? Promise<typeof incoming["children"]> : never
