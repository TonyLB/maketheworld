...
type DFSWalkOptionsBase<IncomingType extends {}, Output, State> = {
...
type DFSWalkOptionsVerbose<IncomingType extends {}, Output, State> = DFSWalkOptionsBase<IncomingType, Output, State> & {
    returnVerbose: true;
}

type DFSWalkOptionsTerse<IncomingType extends {}, Output, State> = DFSWalkOptionsBase<IncomingType, Output, State> & {
    returnVerbose?: false;
}

type DFSWalkOptions<IncomingType extends {}, Output, State> = DFSWalkOptionsVerbose<IncomingType, Output, State> |
    DFSWalkOptionsTerse<IncomingType, Output, State>

const dfsWalkHelper = <IncomingType extends {}, Output, State>(options: DFSWalkOptions<IncomingType, Output, State>) => (previous: { output: Output; state: State }, node: GenericTreeNode<IncomingType>): { output: Output; state: State } => {
...
function dfsWalk<IncomingType extends {}, Output, State>(options: DFSWalkOptionsVerbose<IncomingType, Output, State>): (tree: GenericTree<IncomingType>) => { output: Output; state: State }
function dfsWalk<IncomingType extends {}, Output, State>(options: DFSWalkOptionsTerse<IncomingType, Output, State>): (tree: GenericTree<IncomingType>) => Output
function dfsWalk<IncomingType extends {}, Output, State>(options: DFSWalkOptions<IncomingType, Output, State>): (tree: GenericTree<IncomingType>) => Output | { output: Output; state: State } {
