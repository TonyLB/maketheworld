...
When adding or changing validation, add rules for *which child tags are allowed where* in the Standardize layer (see [AGENT.fromSchema.planning.md](../standardize/components/AGENT.fromSchema.planning.md) Phase 4), not in schema converters.
