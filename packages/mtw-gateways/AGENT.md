...
**Composition slice:** **`{ ComponentAggregate: internalCache.ComponentAggregate }`**. Invalidation bus: [`lambda/assets/componentTopology/AGENT.md`](../../lambda/assets/componentTopology/AGENT.md). Initiative: [`taskPlanning/packages/mtw-wml/AGENT.areaTopologyExits.planning.md`](../../taskPlanning/packages/mtw-wml/AGENT.areaTopologyExits.planning.md).
...
**Consumers:** **`ensureAffordanceTopology`** (hydrate preflight); **`ComponentStackMerge.get`** (compose **`exits`**); nav (**D34**) via **`getRoomExitTargetsForCharacter`**. Steady-state: [`affordanceCache/AGENT.md`](../../lambda/ephemera/dataSource/affordanceCache/AGENT.md). Module doc: [`ts/ephemera/affordanceCache/AGENT.md`](ts/ephemera/affordanceCache/AGENT.md). Deep import: `@tonylb/mtw-gateways/ts/ephemera/affordanceCache`.
