...
| **Component examples (authored slices assembly)** | N/A (compute-only; composes aggregate + enrichment). Steady-state invalidations from [`lambda/assets/componentExamples/`](../../lambda/assets/componentExamples/). | Planned: [`lambda/ephemera/dataSource/renderCache/`](../../lambda/ephemera/dataSource/renderCache/) hydrate (**`assembleComponentExamplesAtPerspective`**); [`lambda/diagnostics/`](../../lambda/diagnostics/) blueprint diff. | **`AuthoredExample`** / **`AuthoredExampleSet`** DTOs; **`assetStackIncludesEditAssetId`** (layer participation). Stub assembly in [`assemble.ts`](ts/assets/components/componentExamples/assemble.ts). Initiative: [`AGENT.onDemandAuthoredExamples.planning.md`](../../taskPlanning/lambda/ephemera/dataSource/renderCache/AGENT.onDemandAuthoredExamples.planning.md). Deep import: `@tonylb/mtw-gateways/ts/assets/components/componentExamples`. |
