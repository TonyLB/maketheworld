...
| **Thinking results (Ephemera thinking rows)** | [`lambda/ephemera/dataSource/thinking/`](../../lambda/ephemera/dataSource/thinking/) (writes: **`EphemeraDataSource`** and persistence modules; **pending** until the results persistence slice lands). | [`lambda/ephemera/internalCache/index.ts`](../../lambda/ephemera/internalCache/index.ts) (**`createThinkingResultReadCacheHandler(ephemeraDB)`** on **`internalCache.ThinkingResults`**). | [`ts/ephemera/thinking`](ts/ephemera/thinking/index.ts): **`JOB#`** adjacency **`Query`**, **`TASK#${workItemId}`** + **`Meta::Result`** **`GetItem`**, **`ThinkingResultEvent`** normalization, **`ThinkingResultReadCache`** (key = **`workItemId`**). Tests: [`index.test.ts`](ts/ephemera/thinking/index.test.ts). Deep import: `@tonylb/mtw-gateways/ts/ephemera/thinking`. Steady-state keys: [`lambda/ephemera/dataSource/thinking/AGENT.md`](../../lambda/ephemera/dataSource/thinking/AGENT.md). |
...
| Ephemera | Same [`index.ts`](../../lambda/ephemera/internalCache/index.ts): **`createThinkingResultReadCacheHandler(ephemeraDB)`** on **`ThinkingResults`** | [`ts/ephemera/thinking`](ts/ephemera/thinking/index.ts) (**`ThinkingResultReadCache`**) |
