...
**Consumers:** **`ensureAffordanceTopology`** (hydrate preflight); **`ComponentStackMerge.get`** (compose **`exits`**); future nav (**D34**) via same slice. Steady-state: [`affordanceCache/AGENT.md`](../../lambda/ephemera/dataSource/affordanceCache/AGENT.md). Deep import: `@tonylb/mtw-gateways/ts/ephemera/affordanceCache`.
