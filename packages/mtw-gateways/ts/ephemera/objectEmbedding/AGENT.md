...
Type authority: [`ephemeraEmbedding.ts`](../../../../mtw-interfaces/ts/ephemeraEmbedding.ts). Value serde: [`semanticEmbedding/AGENT.implementation.md`](../../../../mtw-lambda-patterns/ts/semanticEmbedding/AGENT.implementation.md).
