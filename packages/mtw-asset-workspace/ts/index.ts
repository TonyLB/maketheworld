...
import { NormalAction, NormalBookmark, NormalCharacter, NormalComputed, NormalFeature, NormalForm, NormalItem, NormalMap, NormalRoom, NormalVariable } from '@tonylb/mtw-wml/dist/normalize/baseClasses'
...
const isMappableNormalItem = (item: NormalItem): item is (NormalRoom | NormalFeature | NormalBookmark | NormalMap | NormalCharacter | NormalAction | NormalVariable | NormalComputed) => (['Room', 'Feature', 'Bookmark', 'Map', 'Character', 'Action', 'Variable', 'Computed'].includes(item.tag))
