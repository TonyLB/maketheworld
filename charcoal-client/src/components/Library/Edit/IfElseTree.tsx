...
export const IfElseTree = ({ render: Render, showSelected = false, highlightID = '', onClick }: IfElseTreeProps): ReactElement => {
    ...
    return <React.Fragment>
        ...
        >
            <EditSchema componentKey={componentKey} tag="Statement" field={firstStatement} parentId={field.id} onChange={() => {}}>
                <Render />
            </EditSchema>
        </IfElseWrapBox>
        { 
            otherStatements.map(({ data, children, id }, index) => {
                return isSchemaConditionStatement(data)
                    ? <IfElseWrapBox
                        ...
                        onUnselect={onUnselect}
                    >
                        <EditSchema componentKey={componentKey} tag="Statement" field={{ data, children, id }} parentId={field.id} onChange={() => {}}>
                            <Render />
                        </EditSchema>
                    </IfElseWrapBox>
                    : isSchemaConditionFallthrough(data)
                        ? <IfElseWrapBox
                            ...
                            onSelect={onSelect}
                        >
                            <EditSchema componentKey={componentKey} tag="Fallthrough" field={{ data, children, id }} parentId={field.id} onChange={() => {}}>
                                <Render />
                            </EditSchema>
                        </IfElseWrapBox>
                        : null
