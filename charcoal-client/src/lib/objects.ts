...
//
export const objectFilter = <T, V extends (value: T) => boolean>(obj: ConstrainedMap<T>, condition: V): V extends ((value: T) => value is infer G extends T) ? ConstrainedMap<G> : ConstrainedMap<T> => Object.entries(obj)
