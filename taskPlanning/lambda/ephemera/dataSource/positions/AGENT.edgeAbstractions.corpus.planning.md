...
- **Not [EA-3](AGENT.edgeAbstractions.planning.md#ea-3), [EA-4](AGENT.edgeAbstractions.planning.md#ea-4) or [EA-8](AGENT.edgeAbstractions.planning.md#ea-8).** No boundary is crossed here --- every edge in the setup is between peers or within one host's graph --- so the correspondence questions those rows ask do not arise. **The cut is not a crossing case and should not be pressed into service as one.**
