...
| 3 | Tokenized parse | "Parse" (classify's `objectSpans` extraction + `frameExtract`, consolidated) emits a referent-substituted command skeleton; deterministic Plan-stage template matching can pattern-match it | **Active (2026-07-18)** --- design complete (skeleton shape, Parse/Plan/Synthesize boundary), building the consolidated hop now | [`AGENT.parseTokenization.planning.md`](AGENT.parseTokenization.planning.md) |
