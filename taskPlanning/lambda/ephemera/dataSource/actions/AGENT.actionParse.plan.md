...
4. **Review implemented code**
   ...
   - **Legacy imperative baseline** (parity / migration context): [`lambda/ephemera/parse/executeAction.ts`](../../../../../lambda/ephemera/parse/executeAction.ts) (UI click -> **`Action Assessed`**; retired **`parse/index.ts`**).
