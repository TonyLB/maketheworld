...
**Status:** Scoped through conversation 2026-08-02. Phase 1 (mtw-wml situation facets) and Phase 2 (mtw-gateways host-gate widening) shipped 2026-08-02; Phase 3 in progress (host id types/guards + intake widened 2026-08-02; render pipeline --- WML builder, orchestrate fan-in trio, perspective resolution, look-command routing --- wired 2026-08-02; trusted-UI trigger + client extension still pending); Phases 4--5 not started.
...
| Phase 3 (Character as render-cache host) | In progress --- host id types/guards + intake widened (2026-08-02); WML builder, orchestrate fan-in trio, perspective resolution, and look-command routing wired (2026-08-02); trusted-UI trigger + client extension still pending |
