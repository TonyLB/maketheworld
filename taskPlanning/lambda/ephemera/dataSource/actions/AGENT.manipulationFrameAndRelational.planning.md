...
- **FT-2.2 membership tuple selector (2026-07-10):** membership propose-N + FT-5 legality-gated selector + single-step dry-run + existence guard live ([`selectMembershipFromPool`](../../../../../lambda/ephemera/dataSource/actions/enrich/objectManipulation/selectMembershipFromPool.ts)). Consult/Abstain still map to Error at enrich egress. Gateway exit still blocked on FT-3 Consult wire, LLM joint proposer / frame-extract retirement, and relational selector cutover. Phase C remains blocked.
