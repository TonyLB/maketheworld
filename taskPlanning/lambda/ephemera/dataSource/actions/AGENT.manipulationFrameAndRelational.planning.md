...
| Fault-tolerant gateway ([`AGENT.faultTolerantObjectManipulation.planning.md`](AGENT.faultTolerantObjectManipulation.planning.md)) | In progress (**FT-3.3 relational selector shipped 2026-07-10**; FT-4 e2e/docs/sign-off still open; Phase C blocked) |
