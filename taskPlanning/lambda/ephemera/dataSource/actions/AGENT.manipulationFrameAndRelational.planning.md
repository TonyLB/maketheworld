...
- **FT-1.2 pool merge (2026-07-09):** [`buildSpanCandidatePool`](../../../../../lambda/ephemera/dataSource/actions/enrich/objectManipulation/embeddingMatch/buildSpanCandidatePool.ts) emits `SpanCandidatePool` (rank-all, embed + lexical RMS joint relevance, gap-trim shortlist). C1 `SpanCandidatePool` handoff shape is now buildable; **gateway exit still blocked** (FT-2 identity wiring, FT-3 Consult, FT-5 selector). Production `identityStage` still v1 terminal decision until FT-2.
