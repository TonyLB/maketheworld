...
| Fault-tolerant gateway ([`AGENT.faultTolerantObjectManipulation.planning.md`](AGENT.faultTolerantObjectManipulation.planning.md)) | In progress (FT-0 done 2026-07-09; FT-1.1 + FT-1.1.5 + FT-1.2 + **FT-1.3 calibration** + **FT-1.3.2-1.3.6 calibrated lexical combine** + **FT-1.4 leading-article normalization** shipped 2026-07-09) |
