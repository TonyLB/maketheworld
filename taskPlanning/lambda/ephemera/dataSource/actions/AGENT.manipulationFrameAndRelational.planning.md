...
| BD-13 kernel work, slice 3 of 3: bus payload widening + real producer wiring | **Blocked (2026-07-13), not scheduled** --- awaits Synthesize-stage compiler (real producer) + perception-leg narration design; see BD-13 checklist bullet and its follow-on checkbox |
