...
**Status:** In progress (FT-3.3 relational selector cutover shipped 2026-07-10; LLM joint proposer deferred to Phase C). **Gateway** for Phase C of [`AGENT.manipulationFrameAndRelational.planning.md`](AGENT.manipulationFrameAndRelational.planning.md) --- do not begin Plan IR / compiler work until **Gateway exit** below is satisfied.
...
- [ ] **FT-4** shipped --- span-resolution types + guards in actions layer (**shape decided 2026-07-08**; **types/guards shipped FT-0**; selector wiring shipped FT-2.2/FT-3.3; end-to-end integration + durable docs pending FT-4 build).
...
- [X] [`objectManipulation/AGENT.md`](../../../../../lambda/ephemera/dataSource/actions/enrich/objectManipulation/AGENT.md) updated: trust posture + recovery patterns per hop (**FT-2.1--FT-3.3**; full recovery table deferred to gateway FT-4.2).
...
| **Gateway exit** (unblocks Phase C) | In progress (FT-3.3 done; FT-4 still open; hop retirement deferred to Phase C) |
