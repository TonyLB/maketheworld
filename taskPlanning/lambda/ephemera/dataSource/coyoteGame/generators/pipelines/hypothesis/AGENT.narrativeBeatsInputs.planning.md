...
- **`BEDROCK_HYPOTHESIS_NARRATIVE_BEAT_MAX_TOKENS`** unchanged at **2048** unless raised later with explicit justification (e.g. harness usage + manual load review --- **decision 6**).
...
6. **Token budget**  
   **Decision:** Hold **`BEDROCK_HYPOTHESIS_NARRATIVE_BEAT_MAX_TOKENS`** at **2048** (current default for **`invokeBedrockHypothesisNarrativeBeat`** in [`invokeBedrockHypothesis.ts`](../../../../../../../../lambda/ephemera/dataSource/coyoteGame/generators/pipelines/hypothesis/invokeBedrockHypothesis.ts)). **Do not** raise the cap as part of this refactor without a **convincing** read on real draws (payload growth, model behavior). Production logging/metrics for narrative-beat tokens are **not** planned; harness **`usageNarrativeBeat`** and manual testing are the intended feedback loop. Revisit max tokens only when that feedback (or product need) justifies it (may still land at **2048**).
...
- [X] Inline committed-plan reading contract in [`buildNarrativeBeatPrompt.ts`](../../../../../../../../lambda/ephemera/dataSource/coyoteGame/generators/pipelines/hypothesis/narrativeBeats/buildNarrativeBeatPrompt.ts); remove **`COMBINED_CLUSTERING_CONTRACT_LINES`** import; sweep **`## Combined clustering`** references in [`narrativePromptShared.ts`](../../../../../../../../lambda/ephemera/dataSource/coyoteGame/generators/pipelines/hypothesis/narrativePromptShared.ts) + **`buildNarrativeBeatPrompt`** per decision **3**.
- [X] Adjust [`buildNarrativeBeatPrompt.test.ts`](../../../../../../../../lambda/ephemera/dataSource/coyoteGame/generators/pipelines/hypothesis/narrativeBeats/buildNarrativeBeatPrompt.test.ts) and any combine tests that assert narrative-beat Markdown shape.
- [X] Rename **`CoyoteHarnessPhasePlanInject`** to **`CoyoteHarnessNarrativeBeatsInject`**, strip **`combined`** from inject, wire **`runOnly`** **`phasePlan`** + fixtures (**decision 5**).
- [X] Optional (declined): capture harness **`usage`** as a documented baseline vs production (**decision 6**). Not needed: no production token instrumentation; **`usageNarrativeBeat`** in harness output plus manual testing are enough to judge load. Cap stays **2048** until deliberately revisited.
...
| Implementation | Prompt + pipeline + tests; **line 96 slice:** `parsePlanSelectionHandoff` gate, **`## Committed plan`**, seam-only suffix, tests + [`hypothesis/AGENT.md`](../../../../../../../../lambda/ephemera/dataSource/coyoteGame/generators/pipelines/hypothesis/AGENT.md) updates. **Line 97 slice:** inlined **`COMMITTED_PLAN_MARKDOWN_CONTRACT_LINES`** in [`buildNarrativeBeatPrompt.ts`](../../../../../../../../lambda/ephemera/dataSource/coyoteGame/generators/pipelines/hypothesis/narrativeBeats/buildNarrativeBeatPrompt.ts); removed **`COMBINED_CLUSTERING_CONTRACT_LINES`** from [`narrativePromptShared.ts`](../../../../../../../../lambda/ephemera/dataSource/coyoteGame/generators/pipelines/hypothesis/narrativePromptShared.ts); updated **`VIRTUAL_SCENERY_AND_PREP_OBJECTS_LINES`** for **## Committed plan** grounding. **Lines 98-99 slice:** [`buildNarrativeBeatPrompt.test.ts`](../../../../../../../../lambda/ephemera/dataSource/coyoteGame/generators/pipelines/hypothesis/narrativeBeats/buildNarrativeBeatPrompt.test.ts) + [`combineCandidateOutput`](../../../../../../../../lambda/ephemera/dataSource/coyoteGame/generators/pipelines/hypothesis/candidates/combineCandidateOutput.ts) test/doc clarification for pool Markdown vs committed-plan prompt; **`CoyoteHarnessNarrativeBeatsInject`** (**[`coyoteHarnessInjectTypes.ts`](../../../../../../../../lambda/ephemera/dataSource/coyoteGame/generators/pipelines/hypothesis/coyoteHarnessInjectTypes.ts)**), **`runOnly` `phasePlan`** inject without **`combined`** ([`coyoteHypothesisPipeline.ts`](../../../../../../../../lambda/ephemera/dataSource/coyoteGame/generators/pipelines/hypothesis/coyoteHypothesisPipeline.ts), [`runCoyoteEngineTestHarness.ts`](../../../../../../../../lambda/ephemera/dataSource/coyoteGame/generators/testHarness/runCoyoteEngineTestHarness.ts), [`coyoteEngineTestFixtures.ts`](../../../../../../../../lambda/ephemera/dataSource/coyoteGame/generators/testHarness/coyoteEngineTestFixtures.ts)); [`lambda/ephemera/dataSource/coyoteGame/AGENT.md`](../../../../../../../../lambda/ephemera/dataSource/coyoteGame/AGENT.md) fixtures bullet. |
...
| Token telemetry | Optional baseline vs production **declined**; harness **`usageNarrativeBeat`** + manual testing; **`BEDROCK_HYPOTHESIS_NARRATIVE_BEAT_MAX_TOKENS`** remains **2048** (**decision 6**) |
