...
**Status:** Phase 3 complete. **Next step:** Phase 4 --- migrate Room non-DEFAULT situations list in [`RoomEditor`](../../../../charcoal-client/src/components/Workbench/RoomEdit/RoomEditor.tsx).
