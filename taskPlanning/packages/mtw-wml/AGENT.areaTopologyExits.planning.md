...
**Status:** In progress. **Milestone 0 (decisions)** complete; **Milestone 1** in progress (edge pattern done; D7/D4 next).

**Next step:** Continue **Milestone 1** (**D7** `Edge` reference type + **D4** validation); **M2** may proceed in parallel once gated.
...
| M1 WML + StandardArea edges | In progress (edge pattern done; D7/D4 next) |
