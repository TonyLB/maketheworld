...
| File | Kind | Notes |
| --- | --- | --- |
| [`internalCache/assetData.test.ts`](../../../../lambda/assets/internalCache/assetData.test.ts) | Fixtures | Room rows with `examples` arrays |
| [`internalCache/componentData.test.ts`](../../../../lambda/assets/internalCache/componentData.test.ts) | Fixtures | Room `examples` object shapes |
...
| [`componentExamples/exampleEnrichment.test.ts`](../../../../lambda/assets/componentExamples/exampleEnrichment.test.ts) | Mixed | `examples:` literals for Feature/Knowledge and Room-negative paths (freeze **2026-04-22** cmd 3); do not weaken non-Room coverage |
...
| 4 | Migrate lambda test fixtures | Not started | **D3-D4** with Gate D lambda slices (`examples` cache, `exampleAssociatedFilter`) |
...
- [ ] **`lambda/assets` test migration**
  - [ ] [`internalCache/assetData.test.ts`](../../../../lambda/assets/internalCache/assetData.test.ts)
  - [ ] [`internalCache/componentData.test.ts`](../../../../lambda/assets/internalCache/componentData.test.ts)
  - [ ] [`componentExamples/exampleEnrichment.test.ts`](../../../../lambda/assets/componentExamples/exampleEnrichment.test.ts): verify or adjust `examples:` fixtures without weakening Feature/Knowledge coverage (freeze **2026-04-22**).
  - [ ] [`componentExamples/exampleAssociatedFilter.test.ts`](../../../../lambda/assets/componentExamples/exampleAssociatedFilter.test.ts) when parent **Gate D** implements **D4** (remove `Room` from tag sets)
  - [ ] Targeted Jest runs from `lambda/assets` for modified files.
