...
| --- | --- | --- |
| **Membership persistence API** | [positions --- Slice **1a**](../../../../lambda/ephemera/dataSource/positions/AGENT.positionsDataSource.planning.md#recommended-order) (**shipped:** [`membership/applyCharacterRoomMembership.ts`](../../../../../lambda/ephemera/dataSource/positions/membership/applyCharacterRoomMembership.ts)) | End-to-end fact legs (navigate + disconnect) |
...
- [ ] **Phase 1 --- membership presentation emission ([`mtw.ephemera.perception`](../../../../../lambda/ephemera/dataSource/perception/AGENT.md); **F1-6**)**
  ...
  - [ ] **Positions fact producer (external):** slice **1a** coordinator shipped ([`applyCharacterRoomMembership`](../../../../../lambda/ephemera/dataSource/positions/membership/applyCharacterRoomMembership.ts)); slice **1b** `Character Moved` stream still required for end-to-end publish + integration tests --- track [positions slice **1b**](../../../../lambda/ephemera/dataSource/positions/AGENT.positionsDataSource.planning.md#recommended-order)
