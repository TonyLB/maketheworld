...
| Remaining ephemera migration (P4) | In progress (**PUBLISH-MSG** + **CHECK-LOC** + **WebSocket / api.ephemera ingress** + **ACTIONS-PARSE** + **POSITIONS** done; next: **COMP-KICK + PERCEPTION** -- see **Recommended order** sub-slices) |
