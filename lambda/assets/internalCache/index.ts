...
const InternalCache = JSONFile(Meta(CacheConnectionsByPlayer(CachePlayerSettings(CachePlayerLibrary(CacheLibrary(CacheSessionConnections(CacheConnection(CacheGraph(CacheBase)))))))))
