...
| **Placement** (which host holds the object) | **`Object`** node on room or character **`positionGraph`** + **`OBJECT#`** adjacency | **`mtw.ephemera.positions`** ([`../positions/AGENT.concepts.md`](../positions/AGENT.concepts.md#object-room-placement-nodes-only)) |
