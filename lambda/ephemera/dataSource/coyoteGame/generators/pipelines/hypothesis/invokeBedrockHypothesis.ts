...
/**
 * Narrative beat hop (narrative-beats JSON scratchpad + "## Cartoon play-by-play" or legacy "## Scene analysis" + fenced Hypothesis line).
...
/** Narrative beat hop: leading narrative-beats JSON + "## Cartoon play-by-play" (or legacy "## Scene analysis") + final fenced Hypothesis line. */
