export const INTERPRETATION_RULES_LINES = [
    ...
    '- Focus on what your committed maneuver is intended to do to the Road Runner in cartoon time.',
    ...
    '- Do not narrate the Road Runner\'s escape route or evasion as part of the Hypothesis. The Coyote does not plan to be evaded.',
    '- Bad style: "Hypothesis: It looks like you strap on the rocket skates and sprint after him until he leads you straight into a collision with the rock wall." Good style: "Hypothesis: It looks like you strap on the rocket skates, blast down the straightaway, and pin him at the corner before he can slip past."',
