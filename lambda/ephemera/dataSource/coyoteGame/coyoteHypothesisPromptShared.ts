...
function roomIdsWithStagedObjects(roomObjectsByRoom: Record<EphemeraRoomId, string[]>): EphemeraRoomId[] {
    return (Object.entries(roomObjectsByRoom) as [EphemeraRoomId, string[]][])
