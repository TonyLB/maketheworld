 ...
 * `executeMembershipTransfer`'s `carryClosureTransfer` path owns them, and still does its own
 * cross-snapshot recheck --- they are simply not something establishing a relation can trigger
 * as a side effect.
 */
