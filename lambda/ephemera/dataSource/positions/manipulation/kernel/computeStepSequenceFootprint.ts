 ...
 * newly-discovered host. `transferMembership` contributes `fromHostId`/`toHostId` directly (already
 * fully decided at grounding time, unaffected by BD-36's entity-kind widening); `establishRelation`/
