...
- [`objectManipulation/embeddingMatch/`](./objectManipulation/embeddingMatch/) - pure embedding identity fast path (EM-0 scaffold): `decideEmbeddingMatch`, `rankCatalogByCosineSimilarity`, placeholder `thresholds.ts`; not wired into identity stage until EM-5.
