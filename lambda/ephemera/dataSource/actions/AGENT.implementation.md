...
Parse Requested
  ...
  -> enrichObjectManipulation:
       relational route (expanded prepositions) -> frame extract LLM -> compileRelationalStub -> Error (B1; B3+ EstablishRelation)
