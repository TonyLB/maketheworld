...
| **`featureDescription`** | **`characterId`** (single viewer), routing | Generating/Terminal + **`messageId`**, optional **`createdTime`** | [`orchestrate.ts`](orchestrate.ts) (Phase B slice 2) |
| **`knowledgeDescription`** | **`characterId`**, routing, optional **`directResponse`** (session targeting) | same | [`orchestrate.ts`](orchestrate.ts) (Phase B slice 2) |
