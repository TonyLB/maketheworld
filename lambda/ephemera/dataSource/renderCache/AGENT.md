...
3. **Domain cache** --- For Dynamo shape and `internalCache.RenderCache`, see [`../../renderCache/AGENT.md`](../../renderCache/AGENT.md) and [`../../renderCache/AGENT.migration.md`](../../renderCache/AGENT.migration.md).
...
- [`../../renderCache/AGENT.migration.md`](../../renderCache/AGENT.migration.md) --- boundary invariants.
