...
The first iteration is complete: exact-match Room preview, cache kept in sync via mirroring and ExampleRemoved, Preview UI in the Room Workbench. See `lambda/ephemera/renderCache/AGENT.md` for implementation details.
