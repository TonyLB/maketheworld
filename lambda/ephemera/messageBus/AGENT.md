...
Ephemera-specific lane usage for unmigrated DataSources lives next to those packages. **`renderOrchestration`**, **`affordanceOrchestration`**, and **`actions`** migrated to **`publish`** + boundary drain (P3/P4); see [`../dataSource/renderOrchestration/AGENT.md`](../dataSource/renderOrchestration/AGENT.md), [`../dataSource/affordanceOrchestration/AGENT.md`](../dataSource/affordanceOrchestration/AGENT.md), and [`../dataSource/actions/AGENT.md`](../dataSource/actions/AGENT.md).
