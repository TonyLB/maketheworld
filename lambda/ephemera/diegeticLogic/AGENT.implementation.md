...
**Reference vertical:** **`takeHold`** (pick up). **Navigate** remains the membership fan-in reference for character moves.
...
| Lane | Playbook | Shipped `takeHold` entry points |
| --- | --- | --- |
...
| **positions** | [Adding a cross-host manipulation apply coordinator](../dataSource/positions/AGENT.implementation.md#adding-a-cross-host-manipulation-apply-coordinator) | [`manipulation/membership/executeObjectTakeHold.ts`](../dataSource/positions/manipulation/membership/executeObjectTakeHold.ts) |
...
| **diegeticLogic** | [`AGENT.operators.concepts.md`](AGENT.operators.concepts.md) | **`takeHold`** fiction + unknowns withhold |

Normative contracts: [`../dataSource/positions/AGENT.contract.md`](../dataSource/positions/AGENT.contract.md) (**`Object Moved`**, **`Object Take Hold`** ingress).
