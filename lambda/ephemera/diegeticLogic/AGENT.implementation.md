...
| **positions** | [Adding a cross-host manipulation apply coordinator](../dataSource/positions/AGENT.implementation.md#adding-a-cross-host-manipulation-apply-coordinator) (membership); [`manipulation/relational/`](../dataSource/positions/manipulation/relational/) (relational) | [`executeObjectTakeHold.ts`](../dataSource/positions/manipulation/membership/executeObjectTakeHold.ts), [`executeObjectDrop.ts`](../dataSource/positions/manipulation/membership/executeObjectDrop.ts), [`executeObjectEstablishRelation.ts`](../dataSource/positions/manipulation/relational/executeObjectEstablishRelation.ts), [`executeObjectDissolveRelation.ts`](../dataSource/positions/manipulation/relational/executeObjectDissolveRelation.ts) |
