...
**Shipped (Phase 1--2):** object-manipulation **classify + enrich + resolve** in [`../dataSource/actions/`](../dataSource/actions/) --- **`ObjectManipulationIntent`** classify, [`roomObjectCatalogForCharacter.ts`](../dataSource/actions/roomObjectCatalogForCharacter.ts) (merged-layer catalog), [`enrich/objectManipulation/`](../dataSource/actions/enrich/objectManipulation/) (D17 Bedrock enrich; atomic **`takeHold`** -> grounded **`ObjectManipulation`**); see [`AGENT.implementation.md`](../dataSource/actions/AGENT.implementation.md). **v1 operator:** **`takeHold`** --- pick up removes object from room host graph (positions apply Phase 4). Egress / positions apply / transcript: Phase 3+.
