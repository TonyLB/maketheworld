...
| [`dataSource/perception/AGENT.md`](dataSource/perception/AGENT.md) | **`mtw.ephemera.perception`** fan-in (shipped): normative **routing**, **policy**, **obligations**; consumer side of pass-through; see also [`AGENT.development.md`](dataSource/perception/AGENT.development.md) (follow-on). |
