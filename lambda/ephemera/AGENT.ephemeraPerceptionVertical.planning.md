...
| [dataSource/renderCache/AGENT.md](dataSource/renderCache/AGENT.md) | **`mtw.ephemera.renderCache` DataSource**; **boundary invariants** (writes vs `getExactMatch` lookups) and **regression / equivalence checks** when changing cache behavior. |
